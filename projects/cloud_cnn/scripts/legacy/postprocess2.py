...
data_filenames = glob('/adapt/nobackup/projects/ilab/projects/CloudMask/products/srlite/v1/RailroadValley/*.tif')
output_dir = '/adapt/nobackup/projects/ilab/projects/CloudMask/products/srlite/v1.2/RailroadValley'
