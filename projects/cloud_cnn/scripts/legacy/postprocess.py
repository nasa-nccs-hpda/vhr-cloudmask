...
data_filenames = glob('/adapt/nobackup/projects/ilab/projects/CloudMask/products/srlite/v1/Senegal/*.tif')
output_dir = '/adapt/nobackup/projects/ilab/projects/CloudMask/products/srlite/v1.2/Senegal'
